...
<<<<<<< HEAD
    ...
    vector<Globalization::LangInfo> langs = Globalization::GetLangs();
    Langinfo Info;
...
<<<<<<< HEAD
    ...
    deletebtn = GUI::button(GetStr("NEWorld.worlds.delete"), 10, 250, -80, -56, 0.5, 0.5, 1.0, 1.0);
...
<<<<<<< HEAD
    ...
    rdstbtn = GUI::button(GetStr("NEWorld.options.rendermenu"), -250, -10, 204, 228, 0.5, 0.5, 0.0, 0.0);
    gistbtn = GUI::button(GetStr("NEWorld.options.guimenu"), 10, 250, 204, 228, 0.5, 0.5, 0.0, 0.0);
    langbtn = GUI::button(GetStr("NEWorld.options.languagemenu"), -250, -10, 240, 264, 0.5, 0.5, 0.0, 0.0);
...
<<<<<<< HEAD
    ...
    shadowresbar.text = GetStr("NEWorld.shaders.shadowres") + ss.str() + "x";
    ss.str("");
